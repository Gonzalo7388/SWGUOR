...
export default function SkeletonMaterialesTable() {
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        {/* Thead */}
        <div className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_1fr_80px] gap-4 px-6 py-3 border-b border-slate-100">
        ...
        <div className="p-4 space-y-3">
          {Array.from({ length: 8 }).map((_, i) => (
            <div key={i} className="grid grid-cols-[2fr_1fr_1fr_1fr_1fr_1fr_80px] gap-4 items-center bg-white border border-slate-100 rounded-2xl px-6 py-4 shadow-sm">
              {/* Nombre + composición */}
              ...
              {/* Gramaje */}
              <S className="h-3.5 w-16 rounded mx-auto" />
              {/* Ancho */}
              <S className="h-3.5 w-14 rounded mx-auto" />
              {/* Precio */}
