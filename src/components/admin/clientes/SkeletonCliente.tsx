...
export default function ClientesPageSkeleton() {
  return (
    <div className="p-6 md:p-10 bg-slate-50 min-h-screen">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
          ...
          {/* Thead */}
          <div className="border-b border-slate-100 px-4 py-3 grid grid-cols-[2fr_1fr_1fr_1fr_80px] gap-4">
          ...
          {Array.from({ length: 8 }).map((_, i) => (
            <div key={i} className="px-4 py-4 grid grid-cols-[2fr_1fr_1fr_1fr_80px] gap-4 items-center border-b border-slate-50 last:border-0">
              {/* Cliente — avatar + razón social + ruc */}
              <div className="flex items-center gap-3">
