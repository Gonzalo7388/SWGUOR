...
const ProductoRow = memo(({
  ...
  return (
    <tr 
      ...
      // Navegación al detalle al hacer clic en la fila
    ...
    >
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-2">
              <span className="font-black text-slate-900 text-sm tracking-tight uppercase leading-none group-hover:text-pink-600 transition-colors">
                {p.nombre}
              </span>
      ...
      <td className="bg-white border-y border-slate-100 text-center shadow-sm group-hover:bg-slate-50 transition-all">
        <button
            onClick={(e) => {
              e.stopPropagation(); // Evita navegar al detalle al cambiar estado
              onStatusChange?.(p);
            }}
      ...
      <td 
        className="bg-white border-y border-r border-slate-100 px-6 rounded-r-2xl text-right shadow-sm group-hover:bg-slate-50 transition-all"
        onClick={(e) => e.stopPropagation()} // Evita navegar al detalle al usar acciones
      >
