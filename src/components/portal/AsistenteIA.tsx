...
import { Loader2, MessageSquare, X, Send, Phone, ArrowRight } from 'lucide-react';
...
// Ícono estrella SVG (identidad Nexus)
...
const SendIcon = () => (
  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#D4AF37" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <polygon points="22 2 15 22 11 13 2 9 22 2" fill="#D4AF37" stroke="none" />
  </svg>
);
...
export function AsistenteIA() {
  ...
  const enviarMensaje = async (texto: string) => {
    ...
    try {
      ...
      setChat(prev => [...prev, {
        role: 'bot',
        content: 'No pude procesar su consulta en este momento. Por favor, intente nuevamente.',
      }]);
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="fixed bottom-8 right-8 z-[9999] flex flex-col items-end gap-3">
      ...
      <a
        ...
        className="w-13 h-13 w-[52px] h-[52px] rounded-full flex items-center justify-center shadow-lg hover:scale-105 transition-transform"
      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-1.5 mt-0.5">
                ...
                <span style={{ fontSize: 10, color: '#D4AF37', fontWeight: 500 }}>
          ...
          <div
            ...
            style={{ background: '#fff', borderTop: '0.5px solid #ede8e0' }}
          >
            <input
              value={mensaje}
