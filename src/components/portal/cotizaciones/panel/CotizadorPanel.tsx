...
import { MOQ_MINIMO, ItemCotizacion } from '@/components/portal/_contexts/PortalContext';
...
export function CotizadorPanel({ onEnviar, isSending }: Props) {
    ...
    const itemsConMoqError = itemsBorrador.filter((i: ItemCotizacion) => i.cantidad < MOQ_MINIMO);
