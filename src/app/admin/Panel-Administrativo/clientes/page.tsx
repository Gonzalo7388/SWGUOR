    ...
    <div className="p-4 md:p-8 space-y-6 bg-gray-50/50 min-h-screen">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <AdminPageHeader
          ...
          description="Administración y seguimiento de cartera de clientes corporativos"
          showAction={false}
        >
          {can("export", "clientes") && clientes.length > 0 && (
            <div className="flex gap-2">
              <Button onClick={() =>
                ...
                variant="outline"
                className="bg-white border-red-200 text-red-700 hover:bg-red-50 font-bold gap-2 h-11 rounded-xl shadow-sm transition-all active:scale-95">
              ...
              <Button onClick={() =>
                ...
                variant="outline"
                className="bg-white border-emerald-200 text-emerald-700 hover:bg-emerald-50 font-bold gap-2 h-11 rounded-xl shadow-sm transition-all active:scale-95">
