...
import { EditarOrdenModal } from '@/components/admin/confecciones/EditarOrdenModal'; // ✅ Solo EditarOrdenModal
// ✅ Eliminado: import { NuevaOrdenModal }
...
export default function ConfeccionesPage() {
  ...
  // ✅ Eliminado: const [showCreateModal, setShowCreateModal] = useState(false);
    ...
    <div className="p-4 md:p-8 space-y-6 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          {/* ✅ Eliminado el botón "Nueva Orden" */}
        </div>
      ...
      {/* ✅ Eliminado: Modal de Nueva Orden */}
