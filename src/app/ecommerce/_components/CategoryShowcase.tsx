...
const CATEGORIAS = [
  {
    ...
    imagen: 'bg-linear-to-br from-pink-300 to-pink-500',
    icono: '👗',
  },
  {
    id: 2,
    ...
    imagen: 'bg-linear-to-br from-purple-300 to-purple-500',
    icono: '👕',
  },
  {
    id: 3,
    ...
    imagen: 'bg-linear-to-br from-blue-300 to-blue-500',
    icono: '👖',
  },
  {
    id: 4,
    ...
    imagen: 'bg-linear-to-br from-red-300 to-red-500',
    icono: '👗',
  },
  {
    id: 5,
    ...
    imagen: 'bg-linear-to-br from-yellow-300 to-yellow-500',
    icono: '🧥',
  },
  {
    id: 6,
    ...
    imagen: 'bg-linear-to-br from-green-300 to-green-500',
    icono: '👜',
  },
];
