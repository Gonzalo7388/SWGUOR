...
const PRODUCTOS_DESTACADOS = [
  {
    ...
    price: 89.99,
    oldPrice: 129.99,
    image: 'bg-linear-to-br from-pink-200 to-pink-300',
    rating: 4.5,
    reviews: 128,
    badge: 'Bestseller',
    color: 'Rosa',
  },
  {
    ...
    price: 64.99,
    oldPrice: 94.99,
    image: 'bg-linear-to-br from-purple-200 to-purple-300',
    rating: 4.8,
    reviews: 95,
    badge: 'Nuevo',
    color: 'Púrpura',
  },
  {
    ...
    price: 74.99,
    oldPrice: 99.99,
    image: 'bg-linear-to-br from-gray-300 to-gray-400',
    rating: 4.6,
    reviews: 76,
    badge: 'Oferta',
    color: 'Negro',
  },
  {
    ...
    price: 59.99,
    oldPrice: 84.99,
    image: 'bg-linear-to-br from-gray-200 to-gray-300',
    rating: 4.7,
    reviews: 62,
    badge: 'Top Ventas',
    color: 'Gris',
  },
  {
    ...
    price: 54.99,
    oldPrice: 79.99,
    image: 'bg-linear-to-br from-yellow-100 to-yellow-200',
    rating: 4.9,
    reviews: 110,
    badge: 'Bestseller',
    color: 'Beige',
  },
  {
    ...
    price: 119.99,
    oldPrice: 169.99,
    image: 'bg-linear-to-br from-yellow-300 to-yellow-400',
    rating: 4.8,
    reviews: 84,
    badge: 'Premium',
    color: 'Dorado',
  },
  {
    ...
    price: 44.99,
    oldPrice: 64.99,
    image: 'bg-linear-to-br from-red-200 to-pink-200',
    rating: 4.7,
    reviews: 98,
    badge: 'Oferta Flash',
    color: 'Rosa',
  },
  {
    ...
    price: 69.99,
    oldPrice: 99.99,
    image: 'bg-linear-to-br from-blue-200 to-blue-300',
    rating: 4.6,
    reviews: 71,
    badge: 'Trending',
    color: 'Azul',
