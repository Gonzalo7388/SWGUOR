...
export const metadata: Metadata = {
  title: 'Corte — Sistema GUOR',
  description: 'Módulo de corte de prendas',
  robots: { index: false, follow: false },
};

const ROLES_PERMITIDOS = ['cortador', 'administrador', 'gerente'];
...
export default async function CortadorLayout({
  children,
}: {
