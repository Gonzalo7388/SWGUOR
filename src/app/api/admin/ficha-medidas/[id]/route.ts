...
import { fichaMedidaItemSchema } from '@/lib/schemas/ficha-medidas';
...
export async function PATCH(req: Request, { params }: Params) {
  ...
  try {
    ...
    const parsed = fichaMedidaItemSchema.partial().safeParse(body);
    if (!parsed.success) {
    ...
    const data = await FichaMedidasService.actualizarMedida(id, parsed.data);
