...
export const metadata: Metadata = {
  title: 'Ayudante — Sistema GUOR',
  description: 'Control de calidad y conformidad de taller',
  robots: { index: false, follow: false },
};

const ROLES_PERMITIDOS = ['ayudante', 'administrador', 'gerente'];
...
export default async function AyudanteLayout({
  children,
}: {
